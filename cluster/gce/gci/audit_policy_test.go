...
func TestCreateMasterAuditPolicy(t *testing.T) {
	...
	var (
		...
		npdSA               = serviceaccount.UserInfo(logicalcluster.New(""), "kube-system", "node-problem-detector", "")
		namespaceController = serviceaccount.UserInfo(logicalcluster.New(""), "kube-system", "namespace-controller", "")
		endpointController  = serviceaccount.UserInfo(logicalcluster.New(""), "kube-system", "endpoint-controller", "")
		defaultSA           = serviceaccount.UserInfo(logicalcluster.New(""), "default", "default", "")
