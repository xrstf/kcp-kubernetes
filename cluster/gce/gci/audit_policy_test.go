...
func TestCreateMasterAuditPolicy(t *testing.T) {
	...
	var (
		...
		npdSA               = serviceaccount.UserInfo(logicalcluster.Name(""), "kube-system", "node-problem-detector", "")
		namespaceController = serviceaccount.UserInfo(logicalcluster.Name(""), "kube-system", "namespace-controller", "")
		endpointController  = serviceaccount.UserInfo(logicalcluster.Name(""), "kube-system", "endpoint-controller", "")
		defaultSA           = serviceaccount.UserInfo(logicalcluster.Name(""), "default", "default", "")
